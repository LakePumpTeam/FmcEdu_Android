...
/**
 * Created by Candy on 2015-05-18.
 */
public class Crash  implements Thread.UncaughtExceptionHandler {
    ...
    private static Crash INSTANCE = new Crash();    //程序的Context对象
    ...
    public void init(Context context) {
        ...
        mDefaultHandler = Thread.getDefaultUncaughtExceptionHandler();        //设置该CrashHandler为程序的默认处理器		Thread.setDefaultUncaughtExceptionHandler(this);
    }
