 ...
 */
public class SchoolDynamicEntity implements Parcelable {
    public int newsId;
    ...
    public static final Parcelable.Creator<SchoolDynamicEntity> CREATOR = new Creator<SchoolDynamicEntity>() {
        @Override
