 ...
 */
public class PickerViewControl extends View {
    ...
    public PickerViewControl(Context context) {
        super(context);
        init();
    }

    public PickerViewControl(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
